...
class _MainviewState extends State<Mainview> {
  Future<Map<String, dynamic>> getUserInfo() async {
    DocumentSnapshot userDoc = await FirebaseFirestore.instance.collection('PROFESORES').doc(widget.user.uid).get();
                    ...
                    child: FutureBuilder<List<Map<String, dynamic>>>(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.waiting) {
                          ...
                          onTap: () {
                            Navigator.push(context,MaterialPageRoute(builder: (context) => SeccionesProfesoresPage(profesorUid: widget.user.uid,gradoId: grados[index]['id'],gradoNombre: grados[index]['nombre'],
                        ),
                      ),
                    );
                                    },
